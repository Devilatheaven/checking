      ...
      function dosaminus(){
        ...
        function schezwanfriedriceplus(){
          ...
          function schezwanminus(){
            document.getElementById("itemadded").innerHTML="ADDED";
            var schezwanprice=130;
            sum=sum-schezwanprice; 
            item--;
            nofschezwan--;
            document.getElementById("schezwan").innerHTML="SCHEZWAN FRIED RICE:&emsp;&emsp;&emsp;"; 
            document.getElementById("schezwanprice").innerHTML=schezwanprice;
            if(sum>0 && nofschezwan==0){
            document.getElementById("schezwan").innerHTML=""; 
            document.getElementById("schezwanprice").innerHTML="";
            }
            else if (sum==0 && nofschezwan==0) {
            document.getElementById("schezwan").innerHTML=""; 
            document.getElementById("schezwanprice").innerHTML="";
            } 
            else if(sum<0 && nofschezwan<0){
